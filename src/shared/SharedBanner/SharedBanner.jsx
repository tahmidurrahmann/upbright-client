...
const SharedBanner = ({ heading, passage }) => {
    return (
        <div style={{
            backgroundImage: "url(" + "https://jthemes.net/themes/html/genius-course/assets/img/banner/sd-1.jpg" + ")"}} className="bg-contain sm:bg-cover bg-center bg-no-repeat">
            <div className="max-w-screen-xl mx-auto px-4 py-28 md:py-48 lg:py-56 xl:py-96 w-full 2xl:px-0 space-y-3">
